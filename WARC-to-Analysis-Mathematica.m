...
results=Column[{Style[title,"Title"],Style[date,"Subsection"]," "Style["Preview:","Subsection"],preview,"",Style["Word Cloud","Subsection"],"",Fold[iteration,wordsimg[[1]],Rest[wordsimg]] ,""Style["Keyword-in-Context","Subsection"],output1,"",Style["Topic Models: (more useful on multiple documents)","Subsection"],Take[relbucket,50]//Grid}]; (* slow down here is the Fold[iteration,wordsimg[[1]],Rest[wordsimg]] command, which generates the Word Cloud. Comment out that line if you don't care. Instead could just provide a list of word frequency... maybe that's more rigorous? *)
